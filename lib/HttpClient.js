...
var HttpClient = /** @class */ (function () {
    function HttpClient() {
        ...
        this._api.interceptors.request.use(function (config) { return __awaiter(_this, void 0, void 0, function () {
    ...
    HttpClient.prototype.success = function (response) {
        return response.data;
    };
    HttpClient.prototype.getUrlParam = function (req) {
        var urlParam = "";
        for (var key in req) {
            if (urlParam !== "") {
                urlParam += "&";
